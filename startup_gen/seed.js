...
// db.on('error', console.error.bind(console, 'Database Connection Error:'));
 	...
 	var company = ["Chat Roulette","Tinder", "altSchool", "Medium", "Zipcar", "General Assembly", "HotelTonight", "BirchBox", "Waze", "uber", "airbnb", "Snapchat", "SpaceX", "Pinterest", "Dropbox", "Spotify", "Venmo", "Slack", "Tesla", "Lyft", "Instacart", "Blue Apron", "Netflix", "Google Docs", "Warby Parker", "Gilt", "Shazam", "Lending Club", "Zillow", "HBO", "ebay", "amazon"];
